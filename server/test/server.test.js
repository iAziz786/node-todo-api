...
describe('GET /todos/:id', () => {
    it('should return todo matches with id and creator', (done) => {
        request(app)
    ...
    it('should not return todo if requesting by other user', (done) => {
        request(app)
...
describe('DELETE /todos/:id', () => {
    ...
    it('should not remove an todo by other user', (done) => {
...
describe('POST /users', () => {
  ...
  it('should not create user if email id is exist', (done) => {
...
describe('POST /users/login', () => {
  ...
  it('should retunr 400 in data is invalid', (done) => {
...
describe('DELETE /users/me/token', () => {
  it('should remove the token when logout', (done) => {
